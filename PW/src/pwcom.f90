...
MODULE extfield
  ...
  REAL(DP) :: &
      emaxpos,       &! position of the end of the maximum potential (0<=emaxpos<=1)
      eopreg,        &! length of the scattering region (0<=eopreg, eopreg+emaxpos<=1)
      estep1,        &! length of the left electrode screen zone (0<=estep1<=eopreg)
      estep2,        &! length of the right electrode screen zone (0<=estep2, estep1+estep2<=eopreg)
      estart,        &! start position of the potential (0<=estart<=emaxpos)
      eend,          &! end position of the maximum of the field (emaxpos+eopreg<=eend<=1)
      eamp,          &! bias voltage (in Ry)
